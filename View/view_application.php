            ...
            <form name='job_application_form' id='demo_form' method='post' action='../Controller/process_job_application_form.php'>
                <fieldset id='fs-1'>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type='text' name='fname' id='fname' value='{$row['first_name']}' tabindex='1' disabled><br>
                            </td>
                            <td>
                                <label>Last name</label>
                            </td>
                            <td>
                                <input type='text' name='lname' id='lname' value='{$row['last_name']}' tabindex='1' disabled><br>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' name='email' id='email' value='{$row['email']}' tabindex='1' disabled><br>
                            ...
                            <td>
                                <input type='text' name='phone' id='phone' value='{$row['contact']}' tabindex='1' disabled><br>
                        ...
                        <tr>
                            ...
                            <td>
                              <textarea name='' id='' rows='3' disabled>{$row['address']}</textarea>
                            </td>
                            <td>
                              <label>Gender</label>
                              <td>";
                              if ($row['gender'] == 'Male') {
                                echo "
                                <label>Male</label><input type='radio' name='gender' id='male' value='male' tabindex='1' disabled >
                            <label>Female</label><input type='radio' name='gender' id='female' tabindex='1' checked disabled>
                                ";
                              }
                ...
                <fieldset id='fs-2' >
                    ...
                    <table> 
                        <tr>
                            ...
                            <td>
                                <input type='text' name='nameOfBoardSSC' id='nameOfBoardSSC' tabindex='1' value='{$row['ssc_nob']}' disabled><br>
                            ...
                            <td>
                                <input type='number' name='passingYearSSC' id='passingYearSSC' min='2000' max='2023' tabindex='1' value='{$row['ssc_year']}' disabled><br>
                            ...
                            <td>
                                <input type='number' name='percentageSSC' id='percentageSSC' min='0' max='100' tabindex='1' value='{$row['ssc_per']}' disabled><br>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type='text' name='nameOfBoardHSC' id='nameOfBoardHSC' tabindex='1' value='{$row['hsc_nob']}' disabled><br>
                            ...
                            <td>
                                <input type='number' name='passingYearHSC' id='passingYearHSC min='2000' min='2000' max='2023' tabindex='1' value='{$row['hsc_year']}' disabled><br>
                            ...
                            <td>
                                <input type='number' name='percentageHSC' id='percentageHSC' min='0' max='100' tabindex='1' value='{$row['hsc_per']}' disabled><br>
                    ...
                    <h6>Bachlor Degree</h6>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type='text' name='courseBE' id='courseBE' tabindex='1' value='{$row['be_course']}' disabled><br>
                                ...
                                <td>
                                    <input type='text' name='universityBE' id='universityBE' tabindex='1' value='{$row['be_uni']}'disabled><br>
                                ...
                                <td>
                                    <input type='number' name='passingYearBE' id='passingYearBE' min='2000' max='2023' tabindex='1'  value = '{$row['be_year']}' disabled><br>
                                ...
                                <td>
                                    <input type='number' name='percentageBE' id='percentageBE' min='0' max='100' tabindex='1' value = '{$row['be_per']}' disabled><br>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input type='text' name='courseME' id='courseME' tabindex='1' value = '{$row['me_course']}' disabled><br>
                                ...
                                <td>
                                    <input type='text' name='universityME' id='universityME' tabindex='1' value = '{$row['me_uni']}' disabled><br>
                                ...
                                <td>
                                    <input type='number' name='passingYearME' id='passingYearME' min='2000' max='2023' tabindex='1' value = '{$row['me_year']}' disabled><br>
                                ...
                                <td>
                                    <input type='number' name='percentageME' id='percentageME' min='0' max='100' tabindex='1' value = '{$row['me_per']}' disabled><br>
                ...
                <fieldset id='fs-3' >
                    ...
                    while($row = $result->fetch_assoc()){
                      ...
                      <tr>
                            ...
                            <td>
                                <input type='text' name='companyName1' id='companyName1' tabindex='1' value='{$row['company_name']}' disabled><br>
                            ...
                            <td>
                                <input type='text' name='pastDesignation1' id='pastDesignation1' tabindex='1' value='{$row['designation']}' disabled><br>
                            ...
                            <td>
                                <input type='date' name='fromDate1' id='fromDate1' tabindex='1' value='{$row['to_date']}' disabled><br>
                            ...
                            <td>
                                <input type='date' name='toDate1' id='toDate1' tabindex='1' value='{$row['from_date']}' disabled><br>
                ...
                <fieldset id='fs-4' >
                    ...
                    <table>
                        <tr>";
                            ...
                            if($row['hindi'] == 1){
                              echo "<td><input type='checkbox' name='hindi[]' id='hindi' value='hindi'' tabindex='1' checked disabled>
                              <label for='hindi'><i>Hindi</i></label></td>";
                            }else{
                              echo "<input type='checkbox' name='hindi[]' id='hindi' value='hindi'' tabindex='1' disabled>
                              <label for='hindi'><i>Hindi</i></label></td>";
                            }
                            echo"
                            <td>
                        ...
                        if($row['english'] == 1){
                          echo "<td>
                          <input type='checkbox' name='english[]' id='english' value='english' onclick='enable(); disable();' tabindex='1' checked disabled>
                          <label for='english'><i>English</i></label>
                      </td>";
                        }else{
                          echo "<td>
                          <input type='checkbox' name='english[]' id='english' value='english' tabindex='1' disabled>
                          <label for='english'><i>English</i></label>
                      </td>";
                        }
                        echo "
                        ...
                        if($row['gujarati'] == 1){
                          echo "<td>
                          <input type='checkbox' name='gujarati[]' id='gujarati' value='gujarati' checked onclick='enable(); disable();' tabindex='1' disabled>
                          <label for='gujarati'><i>Gujarati</i></label>
                      </td>
                      </td>";
                        }else{
                          echo "<td>
                          <input type='checkbox' name='gujarati[]' id='gujarati' value='gujarati' onclick='enable(); disable();' tabindex='1' disabled>
                          <label for='gujarati'><i>Gujarati</i></label>
                      </td>";
                        }
                        echo"
                ...
                <fieldset id='fs-5' >
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type='checkbox' name='php' id='php' onclick='enable(); disable();' tabindex='1' disabled>
                        ...
                        <tr>
                            <td>
                                <input type='checkbox' name='mysql' id='mysql' onclick='enable(); disable();' tabindex='1' disabled>
                        ...
                        <tr>
                            <td>
                                <input type='checkbox' name='laravel' id='laravel' onclick='enable(); disable();' value='beginner' tabindex='1' disabled>
                ...
                <fieldset id='fs-6' >
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type='text' name='referenceName1' id='referenceName1' tabindex='1' disabled><br>
                            ...
                            <td>
                                <input type='text' name='referenceContact1' id='referenceContact1' tabindex='1' disabled><br>
                            ...
                            <td>
                                <input type='text' name='referenceRelation1' id='referenceRelation1' tabindex='1' disabled><br>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type='text' name='referenceName2' id='referenceName2' tabindex='1' disabled><br>
                            ...
                            <td>
                                <input type='text' name='referenceContact2' id='referenceContact2' tabindex='1' disabled><br>
                            ...
                            <td>
                                <input type='text' name='referenceRelation2' id='referenceRelation2' tabindex='1' disabled><br>
                ...
                <fieldset id='fs-7' >
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <select name='preferedLocation[]' id='preferedLocation' multiple tabindex='1' disabled>
                            ...
                            <td>
                                <input type='number' name='noticePeriod' id='noticePeriod' min='1' max='4' tabindex='1' disabled>
                                <label>(Months)</label>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type='number' name='expectedCTC' id='expectedCTC' step='50000' tabindex='1' disabled>
                            </td>
                            <td>
                                <label>Current CTC</label>
                            </td>
                            <td>
                                <input type='number' name='currentCTC' id='currentCTC' step='150000' tabindex='1' disabled>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <select name='department' id='department' tabindex='1' disabled>
